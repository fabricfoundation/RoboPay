"""Real vendor DH spec + skill plan for kuka-real-001 (KUKA).

Single source of truth. DH is the published KUKA table; link
lengths/offsets are real. Shared by MuJoCo + PyBullet backends.
"""
from __future__ import annotations
import math

# (a[m], alpha[deg], d[m], theta_home[deg]) -- KUKA DH
DH = [
    (0.0, 90, 0.34, 0),
    (0.0, -90, 0.0, 0),
    (0.0, 90, 0.34, 0),
...
NDOF = 7
LINK_RADII = [0.030 + 0.004 * (7 - i) for i in range(7)]
JOINT_RANGES = [
    (-3.142, 3.142),
    (-3.142, 3.142),
    (-3.142, 3.142),
