# Validation report — kuka-real-001 (RoboPay Tier 1)
...
`robotId: kuka-real-001`, `profileId: kuka.kuka-real-001.mujoco-sim.v1`,
...
`.github/workflows/kuka-real-001-bridge.yml`.
