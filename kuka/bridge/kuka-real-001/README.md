# kuka-real-001 — RoboPay Tier 1 bridge (Simulator Skill Execution)
...
```
 ...
 flow/zenoh_transport.py         publish  robot/tunnel/action
      ▼
 flow/node.py                    kuka-real-001 robot node
      ▼
