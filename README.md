...
## Tier 1 simulator profile: Unitree Go2

This branch includes the Unitree Go2 **simulator-only** Tier 1
profile: a payment-gated MuJoCo obstacle-navigation controller, a shared-policy Webots
...
→ [Go2 bridge README](bridge/unitree/go2_mujoco_bridge/README.md)
