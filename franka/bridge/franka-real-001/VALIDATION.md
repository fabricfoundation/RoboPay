# Validation report — franka-real-001 (RoboPay Tier 1)
...
`robotId: franka-real-001`, `profileId: franka.franka-real-001.mujoco-sim.v1`,
...
`.github/workflows/franka-real-001-bridge.yml`.
