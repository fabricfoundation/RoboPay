"""
MuJoCo simulation runner for Hugging Face Reachy Mini obstacle navigation.

This script:
1. Loads the Mini MuJoCo scene with obstacles
...
def main():
    parser = argparse.ArgumentParser(description="MuJoCo Mini obstacle navigation simulation")
    parser.add_argument("--scene", default="scenes/hugging-face-reachy-mini_obstacle_nav.xml", help="Scene XML file")
