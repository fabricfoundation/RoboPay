"""
MuJoCo simulation runner for Unitree G1 obstacle navigation.

This script:
1. Loads the G1 MuJoCo scene with obstacles
...
def main():
    parser = argparse.ArgumentParser(description="MuJoCo G1 obstacle navigation simulation")
