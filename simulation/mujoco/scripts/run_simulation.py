"""
MuJoCo simulation runner for Deep Robotics M20 Pro obstacle navigation.

This script:
1. Loads the Pro MuJoCo scene with obstacles
...
def main():
    parser = argparse.ArgumentParser(description="MuJoCo Pro obstacle navigation simulation")
    parser.add_argument("--scene", default="scenes/deep-robotics-m20-pro_obstacle_nav.xml", help="Scene XML file")
