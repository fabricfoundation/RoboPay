"""
MuJoCo simulation runner for Boston Dynamics Atlas obstacle navigation.

This script:
1. Loads the Atlas MuJoCo scene with obstacles
...
def main():
    parser = argparse.ArgumentParser(description="MuJoCo Atlas obstacle navigation simulation")
    parser.add_argument("--scene", default="scenes/boston-dynamics-atlas_obstacle_nav.xml", help="Scene XML file")
