"""
MuJoCo simulation runner for Booster K1 obstacle navigation.

This script:
1. Loads the K1 MuJoCo scene with obstacles
...
def main():
    parser = argparse.ArgumentParser(description="MuJoCo K1 obstacle navigation simulation")
    parser.add_argument("--scene", default="scenes/booster-k1_obstacle_nav.xml", help="Scene XML file")
