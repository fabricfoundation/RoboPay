"""
MuJoCo simulation runner for Deep Robotics X30 Pro obstacle navigation.
...
def main():
    ...
    parser.add_argument("--scene", default="scenes/deep-robotics-x30-pro_obstacle_nav.xml", help="Scene XML file")
