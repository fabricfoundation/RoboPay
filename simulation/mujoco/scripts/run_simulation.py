"""
MuJoCo simulation runner for LimX TRON2 obstacle navigation.

This script:
1. Loads the TRON2 MuJoCo scene with obstacles
...
def main():
    parser = argparse.ArgumentParser(description="MuJoCo TRON2 obstacle navigation simulation")
    parser.add_argument("--scene", default="scenes/limx-tron2_obstacle_nav.xml", help="Scene XML file")
