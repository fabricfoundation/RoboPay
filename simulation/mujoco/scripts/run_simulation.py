"""
MuJoCo simulation runner for Boston Dynamics Spot obstacle navigation.

This script:
1. Loads the Spot MuJoCo scene with obstacles
...
def main():
    parser = argparse.ArgumentParser(description="MuJoCo Spot obstacle navigation simulation")
    parser.add_argument("--scene", default="scenes/boston-dynamics-spot_obstacle_nav.xml", help="Scene XML file")
