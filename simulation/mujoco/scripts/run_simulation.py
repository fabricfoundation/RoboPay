"""
MuJoCo simulation runner for Dobot CRA obstacle navigation.

This script:
1. Loads the CRA MuJoCo scene with obstacles
...
def main():
    parser = argparse.ArgumentParser(description="MuJoCo CRA obstacle navigation simulation")
    parser.add_argument("--scene", default="scenes/dobot-cra_obstacle_nav.xml", help="Scene XML file")
