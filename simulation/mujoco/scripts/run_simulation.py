...
def main():
    parser = argparse.ArgumentParser(description="MuJoCo TRON1 obstacle navigation simulation")
    parser.add_argument("--scene", default="scenes/limx-tron1_obstacle_nav.xml", help="Scene XML file")
