#!/usr/bin/env python3
"""
Sim-to-Sim Validation for Booster K1 Obstacle Navigation.
...
def run_mujoco_validation(duration: float = 60.0) -> Optional[SimResult]:
    ...
    scene_path = Path(__file__).parent.parent / "mujoco" / "scenes" / "booster-k1_obstacle_nav.xml"
...
def run_webots_validation(duration: float = 60.0) -> Optional[SimResult]:
    ...
    world_path = Path(__file__).parent.parent / "webots" / "worlds" / "booster-k1_obstacle_nav.wbt"
...
def main():
    parser = argparse.ArgumentParser(description="Sim-to-Sim validation for K1 obstacle navigation")
    ...
    print("=" * 60)
    print("SIM-TO-SIM VALIDATION: Booster K1 Obstacle Navigation")
    print("=" * 60)
