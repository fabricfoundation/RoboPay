#!/usr/bin/env python3
"""
Sim-to-Sim Validation for Hugging Face Reachy Mini Obstacle Navigation.
...
def run_mujoco_validation(duration: float = 60.0) -> Optional[SimResult]:
    ...
    scene_path = Path(__file__).parent.parent / "mujoco" / "scenes" / "hugging-face-reachy-mini_obstacle_nav.xml"
...
def run_webots_validation(duration: float = 60.0) -> Optional[SimResult]:
    ...
    world_path = Path(__file__).parent.parent / "webots" / "worlds" / "hugging-face-reachy-mini_obstacle_nav.wbt"
...
def main():
    parser = argparse.ArgumentParser(description="Sim-to-Sim validation for Mini obstacle navigation")
    ...
    print("=" * 60)
    print("SIM-TO-SIM VALIDATION: Hugging Face Reachy Mini Obstacle Navigation")
    print("=" * 60)
