#!/usr/bin/env python3
"""
Sim-to-Sim Validation for Boston Dynamics Spot Obstacle Navigation.
...
def run_mujoco_validation(duration: float = 60.0) -> Optional[SimResult]:
    ...
    scene_path = Path(__file__).parent.parent / "mujoco" / "scenes" / "boston-dynamics-spot_obstacle_nav.xml"
...
def run_webots_validation(duration: float = 60.0) -> Optional[SimResult]:
    ...
    world_path = Path(__file__).parent.parent / "webots" / "worlds" / "boston-dynamics-spot_obstacle_nav.wbt"
...
def main():
    parser = argparse.ArgumentParser(description="Sim-to-Sim validation for Spot obstacle navigation")
    ...
    print("=" * 60)
    print("SIM-TO-SIM VALIDATION: Boston Dynamics Spot Obstacle Navigation")
    print("=" * 60)
