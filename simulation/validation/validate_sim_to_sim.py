#!/usr/bin/env python3
"""
Sim-to-Sim Validation for Deep Robotics X30 Pro Obstacle Navigation.
...
def run_mujoco_validation(duration: float = 60.0) -> Optional[SimResult]:
    ...
    scene_path = Path(__file__).parent.parent / "mujoco" / "scenes" / "deep-robotics-x30-pro_obstacle_nav.xml"
...
def run_webots_validation(duration: float = 60.0) -> Optional[SimResult]:
    ...
    world_path = Path(__file__).parent.parent / "webots" / "worlds" / "deep-robotics-x30-pro_obstacle_nav.wbt"
...
def main():
    parser = argparse.ArgumentParser(description="Sim-to-Sim validation for Pro obstacle navigation")
    ...
    print("=" * 60)
    print("SIM-TO-SIM VALIDATION: Deep Robotics X30 Pro Obstacle Navigation")
    print("=" * 60)
