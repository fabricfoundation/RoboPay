"""RoboPay -> Spot simulation link: execute paid robot actions in MuJoCo.
...
the Spot skill on the mujoco_menagerie model, and publishes a structured
...
from spot_control import SpotController
...
class Link:
    def __init__(self, model_path=MODEL_PATH, once=False):
        self.controller = SpotController(model_path)
