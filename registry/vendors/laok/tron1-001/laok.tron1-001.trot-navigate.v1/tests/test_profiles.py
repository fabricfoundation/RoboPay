...
REQ = {"skill": "move_forward", "robotId": "tron1-001"}
...
class TestManifestsExist(unittest.TestCase):
    ...
    def test_identity_is_consistent_across_manifests(self):
        ...
        self.assertEqual(rid, "tron1-001")
        self.assertEqual(pid, "laok.tron1-001-arm-001.loco.v1")
...
class TestRobotProfileMatchesSpec(unittest.TestCase):
    """robot.profile.yaml vs tron1_spec.py -- one robot, one description."""
    ...
    def test_embodiment_type_is_planar_quadruped(self):
        self.assertEqual(self.prof["embodiment"]["type"], "planar_quadruped")
        self.assertEqual(self.prof["embodiment"]["degreesOfFreedom"], 9)
...
class TestPaymentPolicy(unittest.TestCase):
    ...
    def test_resource_matches_the_canonical_bounty_id(self):
        ...
        self.assertIn("tron1-001-arm-001", resource)
...
class TestFunctionsManifest(unittest.TestCase):
    ...
    def test_envelope_keeps_the_six_required_fields(self):
        ...
        d = TaskEnvelope("a", "tron1-001", "move_forward", {}, {}, "k").to_dict()
...
class TestProfilesDriveTheRelay(unittest.TestCase):
    ...
    def test_discovery_is_free_and_lists_the_price(self):
        cat = profiles.list_skills("tron1-001")
        self.assertEqual(cat["robotId"], "tron1-001")
        entry = cat["skills"][0]
