# Validation report — tron1-001-arm-001 (RoboPay Tier 1)
...
rejected. The skill executed is **`move_forward / navigate_obstacle / stop`** (real MuJoCo rigid-body dynamics,
...
- `python -m flow.demo --all` prints the per-stage readout (stage / grasp /
  lift / force for arms; phase / foot-target / torque for TRON1), proving the
