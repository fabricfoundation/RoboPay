# Field Validation Runbook — tron1-001 (RoboPay Tier 1)
...
pip install -r bridge/tron1-001/requirements.txt
...
UNITREE_TRON1_PAYMENT_GATE_ZENOH_PORT=7447 \
python tests/test_tron1_001_payment_gate.py -v
```
...
Cross-check on [sepolia.basescan.org](https://sepolia.basescan.org/tx/0xb02f36544c9b42854ed8e641c8cf75d6e4de834a6ef58b4e1fa1b4b896af0d4e).
...
Asserts every number in the five YAML profiles matches `tron1_spec.py` and the
