"""Registry-package payment-gate tests for laok.unitree-g1-arm-001.balance-recover.v1.

Same contract as bridge/unitree-g1-balance/tests/test_payment_gate.py: every case
