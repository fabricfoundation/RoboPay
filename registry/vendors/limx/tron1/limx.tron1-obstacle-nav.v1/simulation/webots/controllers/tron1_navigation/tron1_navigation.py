"""
Webots controller for the LimX TRON1 obstacle-navigation skill.

Runs the SAME potential-field navigation policy as
simulation/runners/tron1_runner.py (MuJoCo), driving a proxy robot body
...
BASE_HALF_EXTENT = (0.14, 0.18)
OBSTACLE_HALF_EXTENT = {
    "obstacle_1": (0.2, 0.2),
    "obstacle_2": (0.25, 0.25),
    "obstacle_3": (0.2, 0.3),
}
