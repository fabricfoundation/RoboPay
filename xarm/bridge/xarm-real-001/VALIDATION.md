# Validation report — xarm-real-001 (RoboPay Tier 1)
...
`robotId: xarm-real-001`, `profileId: xarm.xarm-real-001.mujoco-sim.v1`,
...
`.github/workflows/xarm-real-001-bridge.yml`.
