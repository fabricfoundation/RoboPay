# Demo Video Script — xarm-real-001 / `pick_object`
...
- **On screen:** `README.md` header, then:
  ...
  xarm-real-001  ·  skill: pick_object  ·  engine: MuJoCo 3.11
  ```
- **Voiceover:** "This is xarm-real-001, a paid robotic-arm skill running inside
...
- **Voiceover:** "Fork, drop `bridge/xarm-real-001/` into RoboPay, push, and the
