# Demo Video Script — abb-real-001 / `pick_object`
...
- **On screen:** `README.md` header, then:
  ...
  abb-real-001  ·  skill: pick_object  ·  engine: MuJoCo 3.11
  ```
- **Voiceover:** "This is abb-real-001, a paid robotic-arm skill running inside
...
- **Voiceover:** "Fork, drop `bridge/abb-real-001/` into RoboPay, push, and the
