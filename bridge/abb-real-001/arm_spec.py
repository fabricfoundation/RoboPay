"""Real vendor DH spec + skill plan for abb-real-001 (ABB).

Single source of truth. DH is the published ABB table; link
lengths/offsets are real. Shared by MuJoCo + PyBullet backends.
"""
from __future__ import annotations
import math

# (a[m], alpha[deg], d[m], theta_home[deg]) -- ABB DH
DH = [
    (0.25, -90, 0.4, 0),
    (0.68, 0, 0.0, 0),
    (0.2, -90, 0.0, 0),
