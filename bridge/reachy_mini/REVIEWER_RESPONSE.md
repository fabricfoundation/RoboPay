...
{
  "status": "accepted",
  "timestamp": "2026-07-22T10:55:31-03:00"
}
```
...
```json
{
  ...
  "transaction": "0x6ab3b164a6f64dd5a0a4aaa31a38b168c4ad8dfdd0099718125b25235a54213f",
  "network": "eip155:84532"
}
```
...
6. **Machine Execution**: MuJoCo runs 301 physics steps of closed-loop head tracking, returning correlated metrics receipt:
   ```json
   {
     "correlation_id": "base-sepolia-reachy-1784729088",
