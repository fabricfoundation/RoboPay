"""ROS2 node for Fabric -> LimX TRON2 humanoid adapter.
...
from .mapper import Tron2Mapper
from .skills import SkillManager


class IsaacSimTron2BridgeNode(Node):
    """ROS2 bridge between Fabric tunnel actions and Isaac Sim TRON2.
    ...
    def __init__(self):
        super().__init__("isaac_sim_bridge_tron2")
