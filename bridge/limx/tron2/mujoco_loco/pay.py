#!/usr/bin/env python3
"""pay.py -- mint a REAL x402 payment receipt for limx-tron2 on Base Sepolia.
...
Environment:
  LIMX_TRON2_PRIVATE_KEY   payer private key (funded with Base Sepolia
...
AMOUNT_USDC = 0.10
RESOURCE = "robopay://limx-tron2/{skill}"
...
def main():
    ...
    pk = os.environ.get("LIMX_TRON2_PRIVATE_KEY")
    if not pk:
        sys.exit("set LIMX_TRON2_PRIVATE_KEY (funded Base Sepolia wallet)")
