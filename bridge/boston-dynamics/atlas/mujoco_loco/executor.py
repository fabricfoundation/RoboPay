"""Skill execution interface + executors (boston-dynamics-atlas, Tier 1).

Mirrors the G1 SimExecutor but is engine-backed for boston-dynamics-atlas. The relay
...
class SimExecutor(SkillExecutor):
    """Real Tier 1 executor: physics-backed locomotion on boston-dynamics-atlas."""
