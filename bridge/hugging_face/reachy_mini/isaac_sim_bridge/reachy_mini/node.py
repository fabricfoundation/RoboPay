"""ROS2 node for Fabric → Hugging Face Reachy Mini adapter."""
import rclpy
...
class IsaacSimReachyMiniBridgeNode(Node):
    def __init__(self):
        super().__init__("isaac_sim_bridge_reachy_mini")
...
def main(args=None):
    ...
    node = IsaacSimReachyMiniBridgeNode()
    try:
        rclpy.spin(node)
