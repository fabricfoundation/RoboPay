"""ROS2 node for Fabric -> AGIBot X2 humanoid adapter.
...
from .mapper import AgibotX2Mapper
from .skills import SkillManager


class IsaacSimX2BridgeNode(Node):
    """ROS2 bridge between Fabric tunnel actions and Isaac Sim AGIBot X2.
    ...
    def __init__(self):
        super().__init__("isaac_sim_bridge_x2")
