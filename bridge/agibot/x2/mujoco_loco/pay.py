#!/usr/bin/env python3
"""pay.py -- mint a REAL x402 payment receipt for agibot-x2 on Base Sepolia.
...
Environment:
  AGIBOT_X2_PRIVATE_KEY   payer private key (funded with Base Sepolia
...
AMOUNT_USDC = 0.10
RESOURCE = "robopay://agibot-x2/{skill}"
...
def main():
    ...
    pk = os.environ.get("AGIBOT_X2_PRIVATE_KEY")
    if not pk:
        sys.exit("set AGIBOT_X2_PRIVATE_KEY (funded Base Sepolia wallet)")
