"""Skill execution interface + executors (agibot-x2, Tier 1).

Mirrors the G1 SimExecutor but is engine-backed for agibot-x2. The relay
...
class SimExecutor(SkillExecutor):
    """Real Tier 1 executor: physics-backed locomotion on agibot-x2."""
