...
Topics (all configurable; these are the defaults the README documents):
    ...
    robot/x2/metrics        publish     simulator state metrics for the run
    robot/x2/skills         queryable   skill catalogue, for pre-purchase discovery
...
from .x2.action_contract import ActionEnvelope, ActionRejected
from .x2.mapper import catalogue
from .x2.node import ActionNode, ExecutionResult, IdempotencyStore
from .simulation.runner import TaskRunner

LOG = logging.getLogger("robopay.x2")

DEFAULT_ACTION_TOPIC = "robot/tunnel/action"
DEFAULT_RESULT_TOPIC = "robot/tunnel/result"
DEFAULT_METRICS_TOPIC = "robot/x2/metrics"
DEFAULT_SKILLS_TOPIC = "robot/x2/skills"
