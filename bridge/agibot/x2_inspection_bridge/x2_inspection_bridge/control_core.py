"""Simulator-independent closed-loop policy for the X2 inspection station."""
...
POLICY_ID = "agibot-x2-active-inspection-v1-shared"
VALID_TARGETS = ("left", "center", "right")

# Joint order: waist yaw/pitch/roll, head yaw/pitch, left shoulder
# pitch/roll/elbow, right shoulder pitch/roll/elbow. These are goals for the
# official X2 joints. Progression is gated by measured error and dwell time.
TARGET_POSES = {
    "left": (0.38, 0.0, 0.05, 0.0, 0.50, -0.65, 1.05, -1.05, 0.10, -0.15, -0.35),
    "center": (0.0, 0.03, 0.0, 0.0, 0.50, -0.45, 0.55, -1.00, -0.45, -0.55, -1.00),
    "right": (-0.38, 0.0, -0.05, 0.0, 0.50, 0.10, 0.15, -0.35, -0.65, -1.05, -1.05),
}
