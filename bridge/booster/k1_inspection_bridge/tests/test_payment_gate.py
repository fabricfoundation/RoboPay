...
ROBOT_ID = "booster_k1_payment_gate"
ZENOH_PORT = int(os.environ.get("BOOSTER_K1_PAYMENT_GATE_ZENOH_PORT", "7467"))
...
class K1PaymentGateTests(unittest.TestCase):
    ...
    def test_unpaid_malformed_missing_verdict_and_isvalid_false_fail_closed(self):
        ...
        try:
            proxy.start()
            with tempfile.TemporaryDirectory(prefix="k1_payment_gate_") as temporary:
                ...
                action_id = f"k1-invalid-{uuid.uuid4().hex}"
                ...
                missing_verdict_id = f"k1-missing-verdict-{uuid.uuid4().hex}"
