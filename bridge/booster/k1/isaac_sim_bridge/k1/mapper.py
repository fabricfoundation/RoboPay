"""Booster K1 Mapper — maps Fabric actions to geometry_msgs/Twist.
...
class K1Mapper(CommandMapper):
    """Maps Fabric actions to Twist commands for Booster K1.
    ...
    def map(self, event: ActionEvent) -> Twist:
        ...
        if a in ("move_forward", "forward"):
            ...
            # K1 humanoid cannot walk backward — clamp to 0
            msg.linear.x = 0.0
        elif a == "turn_left":
