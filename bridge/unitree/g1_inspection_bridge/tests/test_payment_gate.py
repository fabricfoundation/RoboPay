...
ZENOH_PORT = int(os.environ.get("UNITREE_G1_PAYMENT_GATE_ZENOH_PORT", "7467"))
...
class G1PaymentGateTests(unittest.TestCase):
    ...
    def test_unpaid_malformed_missing_verdict_and_isvalid_false_fail_closed(self):
        ...
        try:
            proxy.start()
            with tempfile.TemporaryDirectory(prefix="g1_payment_gate_") as temporary:
                ...
                action_id = f"g1-invalid-{uuid.uuid4().hex}"
                ...
                missing_verdict_id = f"g1-missing-verdict-{uuid.uuid4().hex}"
