"""Physics-backed MuJoCo station using Unitree's official G1 29-DoF MJCF."""
...
MODEL_COMMIT = "ae6a8403e272733e9996ef59990880330496177f"


def _station_xml() -> str:
    return """<mujoco model="robopay_unitree_g1_inspection_station">
...
class G1InspectionEnvironment:
    def __init__(self, model_dir: str | None = None):
        ...
        self.left_hand_id = mujoco.mj_name2id(self.model, mujoco.mjtObj.mjOBJ_BODY, "left_wrist_yaw_link")
        self.right_hand_id = mujoco.mj_name2id(self.model, mujoco.mjtObj.mjOBJ_BODY, "right_wrist_yaw_link")
        self.head_id = mujoco.mj_name2id(self.model, mujoco.mjtObj.mjOBJ_BODY, "head_link")
    ...
    def step(self, torque: np.ndarray) -> dict:
        if torque.shape != (29,):
            raise ValueError(f"Expected 29 motor torques, got {torque.shape}.")
