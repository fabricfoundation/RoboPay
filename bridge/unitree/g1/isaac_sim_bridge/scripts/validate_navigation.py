#!/usr/bin/env python3
"""Sim-to-Sim validation for G1 obstacle navigation skill.
...
from g1.skills.obstacle_nav import ObstacleNavSkill
...
def main():
    parser = argparse.ArgumentParser(description="Validate G1 obstacle navigation")
