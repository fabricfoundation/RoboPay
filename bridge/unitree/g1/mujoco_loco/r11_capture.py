...
基于 unitree-g1 的真实 MuJoCo 物理（simulator.MuJoCoSimulator 的 gait solver），
...
运行（在 bridge/unitree-g1 目录）:
    python r11_capture.py
产出: r11/unitree-g1_t1_uncut.mp4  (或 .gif 回退)
...
def draw(phase: str, sub: str, virtual_x=None):
    ...
    fig.text(0.02, 0.94,
             "RoboPay Tier1 · unitree-g1 · move_forward — MuJoCo real physics",
...
def main():
    ...
    out_mp4 = "r11/unitree-g1_t1_uncut.mp4"
    out_gif = "r11/unitree-g1_t1_uncut.gif"
    try:
