...
class Tron1Mapper(CommandMapper):
    """Maps Fabric actions to Twist commands for LimX TRON1 humanoid.
    ...
    def map(self, event: ActionEvent) -> Twist:
        ...
        TRON1 is a humanoid: no backward walking (vx >= 0).
        """
        msg = Twist()
        a = event.action
        ...
        if a in ("move_forward", "forward"):
            ...
            # TRON1 humanoid: backward not supported — issue stop instead
