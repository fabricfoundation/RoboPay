#!/usr/bin/env python3
"""Sim-to-Sim validation for Go2 obstacle navigation skill.
...
from go2.skills.obstacle_nav import ObstacleNavSkill
...
def main():
    parser = argparse.ArgumentParser(description="Validate Go2 obstacle navigation")
