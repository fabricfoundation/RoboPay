# kinova-real-001 — RoboPay Tier 1 bridge (Simulator Skill Execution)
...
| | |
|---|---|
| robotId | `kinova-real-001` |
| profileId | `kinova.kinova-real-001.mujoco-sim.v1` |
...
```
 ...
 flow/zenoh_transport.py         publish  robot/tunnel/action
      ▼
 flow/node.py                    kinova-real-001 robot node
      ▼
