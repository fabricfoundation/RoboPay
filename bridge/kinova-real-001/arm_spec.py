"""Real vendor DH spec + skill plan for kinova-real-001 (Kinova).

Single source of truth. DH is the published Kinova table; link
lengths/offsets are real. Shared by MuJoCo + PyBullet backends.
"""
from __future__ import annotations
import math

# (a[m], alpha[deg], d[m], theta_home[deg]) -- Kinova DH
DH = [
    (0.0, 90, 0.15675, 0),
    (0.0, 90, 0.24365, 0),
    (0.0, 90, 0.0, 0),
