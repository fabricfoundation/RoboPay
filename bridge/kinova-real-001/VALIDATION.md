# Validation report — kinova-real-001 (RoboPay Tier 1)
...
`robotId: kinova-real-001`, `profileId: kinova.kinova-real-001.mujoco-sim.v1`,
...
`.github/workflows/kinova-real-001-bridge.yml`.
