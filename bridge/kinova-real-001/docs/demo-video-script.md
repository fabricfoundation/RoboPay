# Demo Video Script — kinova-real-001 / `pick_object`
...
- **On screen:** `README.md` header, then:
  ...
  kinova-real-001  ·  skill: pick_object  ·  engine: MuJoCo 3.11
  ```
- **Voiceover:** "This is kinova-real-001, a paid robotic-arm skill running inside
...
- **Voiceover:** "Fork, drop `bridge/kinova-real-001/` into RoboPay, push, and the
