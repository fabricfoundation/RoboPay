...
def main():
    ...
    d.text((40, 40), "RoboPay Tier 1 — unitree-g1-arm-001 balance-recover (planar biped)",
           font=_font(20), fill=(220, 220, 220))
    d.text((40, 80), "Real Go Tunnel x402 payment gate | MuJoCo torque-limited balance PD",
           font=_font(18), fill=(160, 160, 160))
    d.text((40, 130), "402 -> pay -> push disturb -> recover / fall -> settle", font=_font(20),
           fill=(110, 200, 110))
    d.text((40, 170), "txHash: 0xcf0222171e83fd6c0d3981cf202de984c1dd0cb10f06d81eef76da779a5fb6d2",
           font=_font(14), fill=(255, 215, 0))
    d.text((40, 200), "payer=0xF2749b5f...07D4a payee=0x742d35Cc...f44e (verified on Base Sepolia)",
