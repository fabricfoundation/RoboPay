"""ROS2 node for Fabric → Boston Dynamics Spot adapter."""
import rclpy
from rclpy.node import Node
from geometry_msgs.msg import Twist

from zenoh_bridge import parse_action_event, ZenohSubscriberHelper
from .mapper import SpotMapper


class IsaacSimSpotBridgeNode(Node):
    def __init__(self):
        super().__init__("isaac_sim_bridge_spot")
