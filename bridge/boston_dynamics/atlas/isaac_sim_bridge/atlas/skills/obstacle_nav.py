"""Policy-driven obstacle navigation for Boston Dynamics Atlas humanoid.
...
class ObstacleNavSkill(RobotSkill):
    ...
    def __init__(
        ...
        self._max_speed = min(max_speed, 0.8)  # Atlas hard limit
        self._max_angular = min(max_angular, 0.3)  # Atlas hard limit
    ...
    def step(self, state: Dict[str, Any]) -> SkillResult:
        ...
        # Atlas cannot walk backward — clamp to non-negative
        speed = max(0.0, speed)
