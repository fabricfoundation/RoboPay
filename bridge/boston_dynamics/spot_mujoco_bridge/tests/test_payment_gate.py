...
ZENOH_TEST_PORT = int(os.environ.get("SPOT_PAYMENT_GATE_ZENOH_PORT", "7447"))
    ...
    def test_unpaid_malformed_and_facilitator_rejected_requests_fail_closed(self) -> None:
        ...
        try:
            ...
            with tempfile.TemporaryDirectory(prefix="spot_payment_gate_") as temp_dir:
                ...
                tampered_id = f"spot-tampered-payment-{uuid.uuid4().hex}"
                ...
                print(
                    "[SPOT PAYMENT GATE] unpaid, malformed, and isValid:false actions: HTTP 402"
                )
        finally:
