"""Zenoh bridge for paid ur5-real-001 ``pick_object`` actions.
...
LOGGER = logging.getLogger("robopay.ur5")

ACTION_TOPIC = "robot/tunnel/action"
RESULT_TOPIC = "robot/tunnel/result"
METRICS_TOPIC = "robot/ur5-real-001/metrics"

ROBOT_ID = "ur5-real-001"
ALLOWED_ACTIONS = {'"pick_and_place"'}
PROFILE_ID = "ur5.ur5-real-001.mujoco-sim.v1"
...
class FabricZenohBridge:
    ...
    def spin(self) -> None:  # pragma: no cover - integration entry point
        LOGGER.info(
            "ur5-real-001 bridge %s listening on %s; publishing results on %s",
...
def main() -> None:  # pragma: no cover - integration entry point
    """Run the ur5-real-001 bridge as a standalone Zenoh worker."""
