# Demo Video Script — ur5-real-001 / `pick_object`
...
- **On screen:** `README.md` header, then:
  ...
  ur5-real-001  ·  skill: pick_object  ·  engine: MuJoCo 3.11
  ```
- **Voiceover:** "This is ur5-real-001, a paid robotic-arm skill running inside
...
- **Voiceover:** "Fork, drop `bridge/ur5-real-001/` into RoboPay, push, and the
