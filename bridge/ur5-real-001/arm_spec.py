"""Real vendor DH spec + skill plan for ur5-real-001 (Universal Robots).

Single source of truth. DH is the published Universal Robots table; link
lengths/offsets are real. Shared by MuJoCo + PyBullet backends.
"""
from __future__ import annotations
import math

# (a[m], alpha[deg], d[m], theta_home[deg]) -- Universal Robots DH
DH = [
    (0.0, -90, 0.08916, 0),
    (-0.425, 0, 0.0, -90),
    (0.0, 90, 0.0, 0),
...
SCENES = {
    "cube":        {"cube": (0.45, 0.0), "obstacle": None, "budget": 400},
    "unreachable": {"cube": (1.20, 0.0), "obstacle": None, "budget": 400},
    "collision":   {"cube": (0.45, 0.0), "obstacle": (0.30, 0.0), "budget": 400},
    "timeout":     {"cube": (0.45, 0.0), "obstacle": None, "budget": 60},
}
