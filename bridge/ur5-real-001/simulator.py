"""Real-DH MuJoCo serial-arm backend for ur5-real-001 (Universal Robots).
...
from arm_spec import (
    DH, JOINT_RANGES, HOME, GRASP_DIST, LIFT_MIN, CUBE_HALF, CUBE_MASS,
...
def _model_xml(cube_xy, obstacle_xy) -> str:
    ...
    return (
        ...
        f"{chain_str}\n        {grip}\n      {close}\n"
        f"    <body name='cube' pos='{cx:.3f} {cy:.3f} {CUBE_HALF:.3f}'>\n"
