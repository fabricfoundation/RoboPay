"""ROS2 node for Fabric → Deep Robotics M20 Pro adapter."""
import rclpy
from rclpy.node import Node
from geometry_msgs.msg import Twist

from zenoh_bridge import parse_action_event, ZenohSubscriberHelper
from .mapper import M20ProMapper


class IsaacSimM20ProBridgeNode(Node):
    def __init__(self):
        super().__init__("isaac_sim_bridge_m20_pro")
