...
## Summary
- **Robot**: deep-robotics-x30-pro, modelled as a **planar quadruped (X30-class, larger)** with 8 actuated joints — 4 legs × hip/knee, plus a posture-locked torso (X/Z translation only, no rotation)
...
> Morphology is defined parametrically in `engine.py` (Morphology): torso 0.26 m, thigh 0.28 m, shank 0.30 m, hip_y 0.15 m, hip_x 0.22 m, walk speed 0.70 m/s.
...
[sepolia.basescan.org](https://sepolia.basescan.org/tx/0xb07aba50e097ed026112290cfdbb988fee33078dbc72a9ce1b11844e711cdeb8):

| field | value |
|---|---|
| txHash | `0xb07aba50e097ed026112290cfdbb988fee33078dbc72a9ce1b11844e711cdeb8` |
| block | `45636897` (confirmed by sequencer, status **Success**) |
...
| resource | `robopay://deep-robotics-x30-pro/move_forward` |
