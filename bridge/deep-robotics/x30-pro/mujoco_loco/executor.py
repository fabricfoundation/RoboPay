"""Skill execution interface + executors (deep-robotics-x30-pro, Tier 1).

Mirrors the G1 SimExecutor but is engine-backed for deep-robotics-x30-pro. The relay
...
class SimExecutor(SkillExecutor):
    """Real Tier 1 executor: physics-backed locomotion on deep-robotics-x30-pro."""
