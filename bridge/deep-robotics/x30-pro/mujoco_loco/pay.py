#!/usr/bin/env python3
"""pay.py -- mint a REAL x402 payment receipt for deep-robotics-x30-pro on Base Sepolia.
...
Environment:
  DEEP_ROBOTICS_X30_PRO_PRIVATE_KEY   payer private key (funded with Base Sepolia
...
AMOUNT_USDC = 0.10
RESOURCE = "robopay://deep-robotics-x30-pro/{skill}"
...
def main():
    ...
    pk = os.environ.get("DEEP_ROBOTICS_X30_PRO_PRIVATE_KEY")
    if not pk:
        sys.exit("set DEEP_ROBOTICS_X30_PRO_PRIVATE_KEY (funded Base Sepolia wallet)")
