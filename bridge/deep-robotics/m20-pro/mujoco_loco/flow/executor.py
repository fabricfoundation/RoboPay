"""Skill execution interface + executors (deep-robotics-m20-pro, Tier 1).

Mirrors the G1 SimExecutor but is engine-backed for deep-robotics-m20-pro. The relay
...
class SimExecutor(SkillExecutor):
    """Real Tier 1 executor: physics-backed locomotion on deep-robotics-m20-pro."""
