"""End-to-end demo client for k1-001 (criterion #1, #10).
...
def run_once(relay: Relay, executor_probe, obj: str, verbose: bool = True,
    ...
    request = {"robotId": ROBOT_ID, "skill": "active_inspection",
...
def main(argv=None) -> int:
    ap = argparse.ArgumentParser(description="k1-001 paid-flow demo")
    ...
    print("=" * 68)
    print(f" RoboPay Tier 1 demo -- {ROBOT_ID} / active_inspection")
