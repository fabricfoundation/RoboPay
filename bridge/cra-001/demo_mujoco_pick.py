"""Live MuJoCo evidence demo for cra-001 (Tier 1, pick_and_stack).
...
the REAL MuJoCo physics backend (not MockExecutor):
  ...
  1. run MuJoCoSimulator.pick_and_stack on a real MJCF scene (gravity, contacts,
