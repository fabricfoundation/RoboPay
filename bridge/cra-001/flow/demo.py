"""End-to-end demo client for cra-001 (criterion #1, #10).
...
def run_once(relay: Relay, executor_probe, obj: str, verbose: bool = True,
    ...
    request = {"robotId": ROBOT_ID, "skill": "pick_and_stack",
...
def main(argv=None) -> int:
    ap = argparse.ArgumentParser(description="cra-001 paid-flow demo")
    ...
    print("=" * 68)
    print(f" RoboPay Tier 1 demo -- {ROBOT_ID} / pick_and_stack")
